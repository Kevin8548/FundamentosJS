...
const pcChoiceImage = document.querySelector('.div4 img'); // Selecciona la imagen de la máquina
...
choices.forEach(choice => {
    choice.addEventListener('click', () => {
        ...
        userChoiceImage.src = choice.src; // Actualiza la imagen del usuario
        userChoiceImage.style.display = 'block'; // Muestra la imagen
    });
});
